...
/**
 * Strings for component 'search_solr', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   search_solr
...
$string['solrhttpconnectiontimeout_desc'] = 'Le délai d\'attente (<i>timeout</i>) de la connection HTTP est la durée maximale autorisées pour le transfert des données HTTP, en secondes.';
