...
/**
 * Strings for component 'bigbluebuttonbn', language 'nl', branch 'MOODLE_37_STABLE'
 *
...
$string['event_activity_created'] = 'BigBlueButtonBN activiteit gemaakt';
$string['event_activity_deleted'] = 'BigBlueButtonBN activiteit verwijderd';
$string['event_activity_updated'] = 'Activiteit bijgewerkt';
$string['event_activity_viewed'] = 'BigBlueButtonBN activiteit bekeken';
...
$string['mod_form_block_participants'] = 'Deelnemers';
...
$string['mod_form_field_notification'] = 'Stuur melding';
$string['mod_form_field_notification_created_help'] = 'Stuur een melding naar aangemelde gebruikers om hen te berichten dat deze activiteit is gecreëerd';
$string['mod_form_field_notification_help'] = 'Stuur een melding naar aangemelde gebruikers om hen te berichten dat deze activiteit is gecreëerd of aangepast';
$string['mod_form_field_notification_modified_help'] = 'Stuur een melding naar aangemelde gebruikers om hen te berichten dat deze activiteit is aangepast';
$string['mod_form_field_notification_msg_at'] = 'op';
$string['mod_form_field_notification_msg_created'] = 'gecreëerd';
...
$string['mod_form_field_welcome_default'] = '<br>Welkom bij <b>%%CONFNAME%%</b>!<br><br>Bekijk onze korte <a href="event:http://www.bigbluebutton.org/content/videos">tutorial video\'s</a> om te leren hoe BigBlueButton werkt.<br><br>Klik op het hoofdtelefoon-icoontje om deel te nemen aan de audioverbinding (bovenaan in het midden). <b>Gebruik een hoofdtelefoon om geen overlast te veroorzaken voor anderen.</b>';
$string['mod_form_field_welcome_help'] = 'Vervangt het standaardbericht dat voor de BigBlueButton server is ingesteld. Het bericht kan sleutelwoorden (%%CONFNAME%%, %%DIALNUM%%, %%CONFNUM%%) bevatten die automatisch vervangen worden, en html tags als <b>...</b> of <i></i>';
$string['modulename'] = 'BigBlueButtonBN';
$string['modulename_help'] = 'Met BigBlueButton BN maak je binnen Moodle links to real-time online klassen die BigBlueButton gebruiken, een open-source webconferencing systeem voor leren op afstand.

Met BigBlueButtonBN kun je de titel, beschrijving, melding in de kalender (die tijdspanne geeft om deel te nemen aan de sessie), groepen en details over de opname van de online sessie specificeren.

Om later opnames te bekijken voeg je RecordingsBN als bron toe aan deze cursus.';
...
$string['view_noguests'] = 'De BigBlueButtonBN is niet geopend voor gasten';
...
$string['view_recording_button_return'] = 'Terug';
