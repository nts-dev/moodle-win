...
/**
 * Strings for component 'tool_policy', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   tool_policy
...
$string['privacy:metadata:acceptances:lang'] = 'La langue utilisée pour afficher la politique lorsque l\'accord a été donné.';
...
$string['privacy:metadata:subsystem:corefiles'] = 'L\'outil des politiques enregistres les fichiers inclus dans la politique intégrale et dans son résumé.';
