...
/**
 * Strings for component 'course', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   course
...
$string['customfield_visibility_help'] = 'Ce réglage détermine qui peut voir le nom et la valeur du champ personnalisé dans la liste des cours.';
