...
$string['emailapprovedbody'] = 'Bonjour {$a->recepientname},
...
$string['emailapprovedsubject'] = 'La question suivante a été approuvée : {$a->questionname}';
$string['emailchangedbody'] = 'Bonjour {$a->recepientname},

Votre question « {$a->questionname} » du cours « {$a->coursename} » dans l\'activité StudentQuiz « {$a->modulename} » a été modifiée par « {$a->actorname} » à « {$a->timestamp} ».

Vous pouvez examiner cette question à : {$a->questionurl}.';
$string['emailchangedsmall'] = 'Votre question « {$a->questionname} » a été modifiée par {$a->actorname}.';
$string['emailchangedsubject'] = 'La question suivante a été modifiée : {$a->questionname}';
...
$string['emaildeletedbody'] = 'Bonjour {$a->recepientname},

Votre question « {$a->questionname} » de l\'activité StudentQuiz « {$a->modulename} » du cours « {$a->coursename} » a été effacée par « {$a->actorname} » à « {$a->timestamp} ».';
$string['emaildeletedsmall'] = 'Votre question « {$a->questionname} » a été supprimée par {$a->actorname}.';
$string['emaildeletedsubject'] = 'La question suivante a été supprimée : {$a->questionname}';
$string['emaildigestbody_section_content'] = 'Votre question <b>{$a->questionname}</b> a été <b>{$a->actiontype}</b> par <b>{$a->actorname}</b>';
$string['emaildisapprovedbody'] = 'Bonjour {$a->recepientname},

Votre question « {$a->questionname} » du cours « {$a->coursename} » dans l\'activité StudentQuiz « {$a->modulename} » a été refusée par « {$a->actorname} » à « {$a->timestamp} ».

Vous pouvez examiner cette question à : {$a->questionurl}.';
$string['emaildisapprovedsmall'] = 'Votre question « {$a->questionname} » a été refusée par {$a->actorname}.';
$string['emaildisapprovedsubject'] = 'La question suivante a été refusée : {$a->questionname}';
$string['emailhiddenbody'] = 'Bonjour {$a->recepientname},

Votre question « {$a->questionname} » du cours « {$a->coursename} » dans l\'activité StudentQuiz « {$a->modulename} » a été cachée par « {$a->actorname} » à « {$a->timestamp} ».

Vous pouvez examiner cette question à : {$a->questionurl}.';
$string['emailhiddensmall'] = 'Votre question « {$a->questionname} » a été cachée par {$a->actorname}.';
$string['emailhiddensubject'] = 'La question suivante a été cachée : {$a->questionname}';
...
$string['emailunhiddenbody'] = 'Bonjour {$a->recepientname},

Votre question « {$a->questionname} » du cours « {$a->coursename} » dans l\'activité StudentQuiz « {$a->modulename} » a été rendue visible par « {$a->actorname} » à « {$a->timestamp} ».

Vous pouvez examiner cette question à : {$a->questionurl}.';
$string['emailunhiddensmall'] = 'Votre question « {$a->questionname} » a été rendue visible par {$a->actorname}.';
$string['emailunhiddensubject'] = 'La question suivante a été rendue visible : {$a->questionname}';
...
$string['messageprovider:disapproved'] = 'Notification de refus de question';
$string['messageprovider:hidden'] = 'Notification de question cachée';
$string['messageprovider:minecommentdeleted'] = 'Notification de suppression de mon commentaire';
$string['messageprovider:unhidden'] = 'Notification de question rendue visible';
...
$string['studentquiz:emailnotifydeleted'] = 'Notification de suppression de question';
