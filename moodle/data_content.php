...
//        echo json_encode(array('command' => "moosh -n activity-add --name='" . $page_name . "' --section=" . $section_id . " --options='--content=" . $content . "' page " . $course_id));
        //        exit;
        //'C:\xampp\moosh' script

        // echo "'C:\xampp\moosh' -n activity-add --name='" . $page_name . "' --section=" . $section_id . " page " . $course_id;
        // exit;
        $page_id = exec('"C:\xampp\moosh" -n activity-add --name="' . $page_name . '" --section=' . $section_id . ' page ' . $course_id);
        ...
        if ($parent_id == 0) {
            ...
            $section = $DB->get_field('course_modules', 'section', ['instance' => $page_id, 'module' => 15], $strictness = IGNORE_MISSING);
        }
    ...
    case 6:
        ...
        $params = ['course' => $course_id, 'module' => 13];
