...
/**
 * Strings for component 'tool_analytics', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['getpredictionsresults'] = 'Résultats utilisant la méthode de division temporelle {$a->name}';
$string['getpredictionsresultscli'] = 'Résultats utilisant la méthode de division temporelle {$a->name} (id: {$a->id})';
