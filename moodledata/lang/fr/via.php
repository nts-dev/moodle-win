...
/**
 * Strings for component 'via', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   via
...
$string['activitytemplatedesc'] = 'Les valeurs par défaut dans le portail Via (mode d\'enregistrement, le profil multimédia, la salle d’attente, etc.) seront appliqués comme valeur par défaut lors de la création d\'une nouvelle classe virtuelle. Vous devez vous connecter au portail Via, accéder à la section « Modèle d’activité » pour modifier les valeurs par défaut.';
...
$string['emails_alert_addressdesc'] = 'Adresses courriels pour l\'envoi des avertissements de débordement. Si plusieurs, séparer les adresses par des virgules.';
...
$string['portalaccessdesc'] = 'Permet aux utilisateur d\'accéder au portail Via  à partir de leur état de session dans Moodle. En effet, lorsque l\'utilisateur accès  à une activité Via  à partir de Moodle, son état de session est actif dans le
...
$string['unplanned'] = 'Non plannifié';
...
$string['usersynch'] = 'Les utilisateurs seront automatiquement associés à l\'activité lorsqu\'ils se connectent. <br/> Si vous souhaitez effectuer une pré-associé alors afin de les affecter à des ateliers, cliquez ici:';
...
$string['viacategoriesdesc'] = 'Si cochée, les catégories créées dans Via peuvent être ajoutés à l\'activité.';
