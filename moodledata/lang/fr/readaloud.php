...
/**
 * Strings for component 'readaloud', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   readaloud
...
$string['attemptsbyuserheading'] = 'Rapport des tentatives';
$string['attemptsheading'] = 'Résultat des tentatives';
$string['attemptsreport'] = 'Résultat des tentatives';
...
$string['defaultwelcome'] = 'Veuillez lire le passage suivant à voix haute.';
...
$string['mingradedetails'] = 'Note minimale (%) de lecture à voix haute nécessaire pour « terminer » cette activité.';
$string['mistakes'] = 'Erreurs';
$string['modulename'] = 'Lecture à voix haute';
$string['modulenameplural'] = 'Lectures à voix haute';
$string['name'] = 'Nom';
$string['nodataavailable'] = 'Aucune donnée disponible';
$string['notgradedyet'] = 'Voter dernière tentative n\'a pas encore été évaluée.';
...
$string['welcomelabel_details'] = 'Texte par défaut à afficher dans l\'espace d\'accueil lors de la création d\'une nouvelle activités de Lecture à voix haute.';
$string['wpm'] = 'MPM';
