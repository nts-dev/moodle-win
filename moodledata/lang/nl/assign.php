...
/**
 * Strings for component 'assign', language 'nl', branch 'MOODLE_37_STABLE'
 *
 * @package   assign
...
$string['submissionstatement_help'] = 'Verklaring die de leerling moet aanvaarden voor insturen van zijn opdracht';
