...
/**
 * Strings for component 'groupformation', language 'fr', branch 'MOODLE_35_STABLE'
 *
...
$string['analysis_status_info0'] = 'Vous pouvez commencer ou terminer l\'activité.';
$string['analysis_status_info1'] = 'Vous devez arrêter l\'activité avant la formation du groupe.';
$string['analysis_status_info2'] = 'Vous devez commencer l\'activité pour que les élèves soient en mesure de répondre au questionnaire.';
$string['analysis_status_info3'] = 'La formation des groupes a déjà commencé ou est déjà faite. L\'activité ne peut plus être démarrée. Si vous voulez relancer l\'activité, vous devez supprimer les groupes générés.';
$string['analysis_status_info4'] = 'Vous pouvez maintenant commencer la formation de groupe.';
...
$string['groups_build'] = 'Des groupes se forment.';
...
$string['participant_code_example'] = 'Exemple: EV07AD11';
$string['participant_code_footer'] = 'Votre code personnel de participant est';
$string['participant_code_header'] = 'Veuillez entrer un code de participant personnel basé sur les règles suivantes :';
$string['participant_code_rules'] = '1. Le prénom de votre mère (les deux premiers caractères, en majuscules, ex:. EV pour Eva)<br>
2. Le mois de naissance de votre mère (en deux chiffres, ex: 07 pour juillet)<br>
3. Le prénom de votre père (les deux premiers caractères, en majuscules, ex:. AD pour Adam)<br>
4. Le mois de naissance de votre père (en deux chiffres,ex: 11 pour novembre)<br><br>
pas de caractères spéciaux tels que â,ou ö';
