...
/**
 * Strings for component 'scheduler', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   scheduler
...
$string['areaappointmentnote'] = 'Fichiers dans le commentaire d\'entretien';
$string['areaslotnote'] = 'Fichiers dans le commentaire de créneau';
$string['areateachernote'] = 'Fichiers dans le commentaire confidentiel';
...
$string['field-teachernote'] = 'Commentaire sur l\'entretien (pour l\'enseignant uniquement)';
...
$string['usenotesboth'] = 'Les deux types de commentaires';
$string['usenotesnone'] = 'Aucun';
$string['usenotesstudent'] = 'Commentaire d\'entretien, visible pour l\'enseignant et l\'étudiant';
$string['usenotesteacher'] = 'Commentaire confidentiel, visible pour l\'enseignant seulement';
