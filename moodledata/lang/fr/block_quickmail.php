...
/**
 * Strings for component 'block_quickmail', language 'fr', branch 'MOODLE_35_STABLE'
 *
...
$string['are_you_sure'] = 'Voulez-vous vraiment supprimer {$a->title} ? Cette action est irréversible !';
...
$string['delete_confirm'] = 'Voulez-vous vraiment supprimer le message avec les détails suivants : {$a}';
...
$string['sure'] = 'Voulez-vous vraiment supprimer {$a->address} ? Cette action ne peut être annulée.';
