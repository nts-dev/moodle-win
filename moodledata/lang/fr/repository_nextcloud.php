...
/**
 * Strings for component 'repository_nextcloud', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['contactadminwith'] = 'L\'action requise n\'a pas pu être effectuée. Si cela se reproduit, veuillez contacter l\'administrateur du site en indiquant les informations suivantes : <br />« <i>{$a}</i> »';
