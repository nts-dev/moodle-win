...
/**
 * Strings for component 'hub', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   hub
...
$string['enablecoursepublishing'] = 'Partage de cours sur Moodle.net';
$string['enablecoursepublishing_help'] = 'Moodle.net est notre site communautaire pour le partage de cours et de contenus avec d\'autres utilisateurs de Moodle dans le monde. Un cours peut être partagé afin que d\'autres puissent s\'y inscrire (nécessite l\'auto-enregistrement par courriel sur le site et l\'auto-inscription dans le cours) ou comme fichier de sauvegarde afin que d\'autres le téléchargent.';
