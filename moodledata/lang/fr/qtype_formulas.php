...
/**
 * Strings for component 'qtype_formulas', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['answercoordinatemulti'] = 'Réponse pour la partie {$a->part} et coordonnées {$a->numanswer}';
