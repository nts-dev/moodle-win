...
/**
 * Strings for component 'block_opencast', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['delete_confirm'] = 'Êtes-vous sûr de vouloir supprimer ce rôle ?';
...
$string['editseriesforcourse'] = 'Éditer le mappage des séries';
$string['edituploadjobs'] = 'Ajouter une vidéo / Editer les tâches de dépôt';
...
$string['show_public_channels'] = 'Voir les canaux de publication';
$string['show_public_channels_desc'] = 'Si coché, les utilisateurs pourront voir la colonne avec le canal de publication dans la liste des vidéos publiées.';
