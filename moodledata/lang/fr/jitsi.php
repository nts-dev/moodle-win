...
/**
 * Strings for component 'jitsi', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   jitsi
...
$string['infoicon'] = 'Icône d\'information';
$string['infoiconex'] = 'Afficher l\'icône d\'information sur la session';
...
$string['jitsiname_help'] = 'Utiliser le module Jitsi pour la vidéoconférence';
$string['jitsi:sharedesktop'] = 'Partage du bureau';
$string['jitsi:submit'] = 'Soumettre Jitsi';
...
$string['serverexpl'] = 'URL du serveur Jitsi';
