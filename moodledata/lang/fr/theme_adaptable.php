...
/**
 * Strings for component 'theme_adaptable', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['alertcolorsheadingdesc'] = 'Définissez les couleurs et icônes.';
...
$string['alerthiddencourse'] = 'Avertissement de cours caché';
$string['alerthiddencoursedesc'] = 'Affiche une alerte sur la page du cours s\'il est caché.';
...
$string['alerticoninfodesc'] = 'Définissez <a href="http://fortawesome.github.io/Font-Awesome/icons/">l\'icône de la Police Awesome</a> qui doit être utilisée dans les fenêtres d\'alerte de type Info. Entrez le nom de l\'icône sans son préfixe fa-.';
$string['alerticonsuccess'] = 'Icône d\'annonce';
$string['alerticonsuccessdesc'] = 'Définissez <a href="http://fortawesome.github.io/Font-Awesome/icons/">l\'icône de la Police Awesome</a> qui doit être utilisée dans les fenêtres d\'alerte de type Annonce. Entrez le nom de l\'icône sans son préfixe fa-.';
$string['alerticonwarning'] = 'Icône des Avertissements';
$string['alerticonwarningdesc'] = 'Définissez <a href="http://fortawesome.github.io/Font-Awesome/icons/">l\'icône de la Police Awesome</a> qui doit être utilisée dans les fenêtres d\'alerte de type Avertissement. Entrez le nom de l\'icône sans son préfixe fa-.';
...
$string['blockiconsheadersizedesc'] = 'Définissez la taille de l’icône de police utilisée dans l’en-tête des blocs moodle. Sélectionnez une valeur dans la liste.';
...
$string['blockmainbottomradiusdesc'] = 'Paramétrez le rayon bas du bloc principal pour donner un effet arrondi';
...
$string['breadcrumbseparatordesc'] = 'Définissez <a href="http://fortawesome.github.io/Font-Awesome/icons/">l\'icône de la Police Awesome</a> qui doit être utilisée comme séparateur dans le fil d\'ariane. Entrez le nom de l\'icône sans son préfixe fa-.';
...
$string['buttoncancelbackgroundcolor'] = 'Couleur du fond du bouton Annuler';
$string['buttoncancelbackgroundcolordesc'] = 'Couleur du fond du bouton Annuler. Saisir <i>transparent</i> dans la boite pour la transparence';
$string['buttoncancelcolor'] = 'Couleur du bouton Annuler';
$string['buttoncancelcolordesc'] = 'Choisir la couleur du bouton Annuler';
...
$string['buttonloginheight'] = 'Configurez la hauteur du bouton Connexion';
...
<h2>Credits</h2>
<h3>About</h3>
<p>Adaptable est un thème responsive en 2 colonnes très paramétrable et basé sur le thème populaire BCU. La version 2 utilise Boost en tant que thème de base et donc Bootstrap 4.</p>
<p>Ce thème est sous licence GPL (GNU General Public License). Vous trouverez un exemplaire complet de cette licence <a href="http://www.gnu.org/licenses/" target="_HERE">blank</a></p>
<br>
...
<p> Lors du développement de la version 2, ont également collaboré : <br>
Gareth J. Barnard (http://moodle.org/user/profile.php?id=442195)
Stuart Lamour
Alistair Spark (University College London)
<br>
<p>et beaucoup d\'autres développeurs, testeurs, traducteurs et volontaires (Voir <a href="adaptable/README.txt" target="_blank">README.txt</a>)</p>
<br>
<h3>Signalement de Bugs</h3>
<p>Vous pouvez signaler des bugs (et s\'il vous plait, <b>SEULEMENT</b> bugs) dans notre <a href="https://gitlab.com/3bits/moodle-theme_adaptable2" target="_blank">dépôt</a></p>
<br>
<h3>Support Technique</h3>
<p>Vous pouvez demander un support technique dans le forum Moodle :
<ul>
...
<br>
<h3>Demo</h3>
<p>Vous pouvez voir une version de démo <a href="https://adaptable.ws/demo" target="_blank">ICI</a></p>
<br>
</div>
</div>';
...
$string['commonlyusedar'] = 'Activités et ressources couramment utilisées';
$string['commonlyusedardesc'] = 'Utilisez cette case pour spécifier la liste des noms d’activités / ressources (séparés par des virgules) que vous souhaitez voir en haut du sélecteur de module. Les noms possibles actuels sont {$a}.';
$string['commonlyusedartitle'] = 'Activités et ressources couramment utilisées';
...
$string['coursepageblocklayoutbuilderdesc'] = 'Ci-dessous, vous pouvez créer votre propre mise en page pour les zones de blocs sur la page du cours.
Pour ajouter du contenu dans ces zones, vous devez <strong> activer la modification sur la page de cours de Moodle </strong>.
Ensuite, vous pouvez commencer à glisser/déposer des blocs dans les zones que vous créez !';
$string['coursepageblocklayoutlayoutbottomrowdesc'] = 'Ajouter/définir la disposition des lignes des zones de blocs sur les page de cours.';
...
$string['coursesectionactivityassignbgcolordesc'] = 'Ce champ permet de définir la couleur de fond de l\'activité Devoir';
...
$string['coursesectionactivitybordercolor'] = 'Couleur de la bordure basse des sections de cours';
...
$string['coursesectionactivityforumbgcolordesc'] = 'Ce champ permet de définir la couleur de fond de l\'activité Forum.';
...
$string['coursesectionactivityquizbgcolordesc'] = 'Ce champ permet de définir la couleur de fond de l\'activité Test';
...
$string['coursesectionactivityuseadaptableiconsdesc'] = 'Activez cette option pour utiliser les icônes du thème Adaptables. Si elle est désactivée, veillez également à supprimer les répertoires adaptables/pix_plugins et adaptable/pix_core/f pour utiliser les icônes Moodle par défaut.';
...
$string['coursesectionborderstyledesc'] = 'Configurez le style de bordure des sections de cours';
...
$string['coursesectionheaderbgdesc'] = 'Configurez la couleur d\'arrière-plan des en-têtes des sections de cours';
...
$string['coursesectionheaderborderradiusbottomdesc'] = 'Configurez la rayon de la bordure du bas des en-têtes des sections de cours (coins arrondis)';
$string['coursesectionheaderborderradiustop'] = 'Rayon de la bordure du haut des en-têtes des sections de cours';
$string['coursesectionheaderborderradiustopdesc'] = 'Configurez la rayon de la bordure du haut des en-têtes des sections de cours (coins arrondis)';
$string['coursesectionheaderborderstyle'] = 'Style de bordure des en-têtes des sections de cours';
$string['coursesectionheaderborderstyledesc'] = 'Configurez le style de bordure des en-têtes des sections de cours (seule la bordure du bas est utilisée puisque le conteneur extérieur a également une bordure)';
$string['coursesectionheaderborderwidth'] = 'Largeur de bordure des en-têtes des sections de cours';
$string['coursesectionheaderborderwidthdesc'] = 'Configurez la largeur de bordure des en-têtes des sections de cours (seule la bordure du bas est utilisée puisque le conteneur extérieur a également une bordure)';
...
$string['coursetitlemaxwidthdesc'] = 'Paramétrez la largeur maximale du titre de cours';
$string['coursetitlepaddingleft'] = 'Marge gauche du titre de cours';
$string['coursetitlepaddingleftdesc'] = 'Configurez la marge gauche du titre de cours pour ajuster la position';
$string['coursetitlepaddingtop'] = 'Marge haute du titre de cours';
$string['coursetitlepaddingtopdesc'] = 'Configurez la marge au-dessus du titre de cours pour ajuster la position';
...
$string['customfontheadername'] = 'Police d\'en-tête personnalisée';
$string['customfontheadernamedesc'] = 'Entrez le nom de la police d\'en-tête personnalisée uniquement si vous avez sélectionné \'Personnaliser\' dans la liste déroulante des polices d\'en-tête.';
$string['customfontname'] = 'Police principale personnalisée';
$string['customfontnamedesc'] = 'Entrez le nom de la police principale personnalisée uniquement si vous avez sélectionné l\'option « Personnalisé ». dans la liste déroulante Police principale.';
$string['customfonttitlename'] = 'Police de titre personnalisée';
$string['customfonttitlenamedesc'] = 'Entrez le nom de la police de titre personnalisée uniquement si vous avez sélectionné « Personnalisé » dans la liste déroulante Police du titre.';
...
$string['dashblocklayoutbuilderdesc'] = 'Ci-dessous, vous pouvez créer votre propre mise en page pour les zones de blocs dans le Tableau de bord.
Pour ajouter du contenu à ces zones, vous devrez <strong> activer l\'édition, sur la page du tableau de bord de Moodle </strong>.
Ensuite, vous pouvez faire glisser/déposer des blocs dans les zones que vous avez créées !';
...
$string['dashblocksenableddesc'] = 'Vous pouvez activer / désactiver les zones de blocs personnalisées dans le tableau de bord.
Vous pouvez ensuite glisser et déposer des blocs dans les zones que vous avez créées';
...
$string['dashboardblockregionsettings'] = 'Constructeur de zone de bloc de tableau de bord';
...
$string['displaylogindesc'] = 'Sélectionnez comment afficher la connexion à l\'écran (si activée ci-dessus).';
...
$string['draft'] = 'Non affiché aux étudiants';
$string['due'] = 'Dû {$a}';
$string['editfont'] = 'Couleur de police du bouton Editer et personnaliser cette page';
$string['editfontdesc'] = 'Configurez la couleur de police du bouton Editer et personnaliser cette page';
$string['edithorizontalpadding'] = 'Configurez l\'espacement horizontal des boutons d\'édition';
$string['editoffbk'] = 'Arrière-plan';
$string['editoffbkdesc'] = 'Configurez la couleur d\'arrière-plan du bouton Editer et personnaliser cette page lorsqu\'il est désactivé';
$string['editonbk'] = 'Couleur d\'arrière-plan du bouton Editer et personnaliser cette page';
$string['editonbkdesc'] = 'Configurez la couleur d\'arrière-plan du bouton Editer et personnaliser cette page';
...
$string['editverticalpadding'] = 'Configurez l\'espacement vertical des boutons d\'édition';
...
$string['enablealert'] = 'Activez la boîte d\'alerte {$a}';
$string['enablealertcoursepages'] = 'Activez la boîte d\'alerte sur les pages de cours';
$string['enablealertcoursepagesdesc'] = 'Activez cette option affichera la boîte d\'alerte sur toutes les pages de cours';
...
$string['enablemysitesrestrictiondesc'] = 'Limitez le menu déroulant aux cours d\'un utilisateur avec le champ de profil personnalisé. Par exemple : usertype=staff';
...
$string['enablesavecanceloverlaydesc'] = 'Affichez l’incrustation d’un bouton Enregistrer/Annuler en haut d’une page de paramètres pour faciliter l’enregistrement des paramètres.';
...
$string['fontblockheadercolordesc'] = 'Ce champ permet de définir la couleur de la police d\'en-tête des blocs Moodle, utilisez le code hexadécimal html.';
$string['fontblockheadersize'] = 'Taille de la police de l\'en-tête des blocs';
$string['fontblockheadersizedesc'] = 'Définissez la taille de la police utilisée dans l\'en-tête des blocs Moodle. Sélectionnez une valeur dans la liste.';
$string['fontblockheaderweight'] = 'Poids de la police de l\'en-tête des Blocs';
$string['fontblockheaderweightdesc'] = 'Définissez le poids de la police utilisée dans l\'en-tête des blocs Moodle. Sélectionnez une valeur de 100 à 900 selon la police sélectionnée.';
...
$string['fontheadernamedesc'] = 'Sélectionnez la police par défaut ou la police <a href="https://www.google.com/fonts" target="_blank">Google Fonts</a> utilisée dans les en-têtes de bloc et les textes.';
...
$string['fontnamedesc'] = 'Sélectionnez la police par défaut ou la police <a href="https://www.google.com/fonts" target="_blank">Google Fonts</a> utilisée dans le site';
...
$string['fontsubsetdesc'] = 'Sélectionnez un autre sous-ensemble de caractères que latin à appliquer à toutes les polices. Le sous-ensemble latin est inclus par défaut.';
$string['fonttitlecolor'] = 'Couleur de la police du titre du cours / site';
...
$string['fonttitlenamedesc'] = 'Sélectionnez la police par défaut ou une police <a href="https://www.google.com/fonts" target="_blank">Google Fonts</a> utilisée pour le titre du site et des cours.';
$string['fonttitlesize'] = 'Taille de la police du titre du site et des cours';
$string['fonttitlesizedesc'] = 'Taille de police du titre du site et des cours utilisée dans le site. Sélectionnez une valeur dans la liste.';
$string['fonttitleweight'] = 'Épaisseur de la police du titre du site et des cours';
$string['fonttitleweightdesc'] = 'Configurez l\'épaisseur de la police du titre du site et des cours. Saisissez une valeur entre 100 et 900 selon la police choisie.';
$string['fontweight'] = 'Épaisseur de la police principale';
$string['fontweightdesc'] = 'Épaisseur de la police utilisée dans le site. Saisissez une valeur entre 100 et 900 selon la police choisie.';
...
$string['footercontentdesc'] = 'Ajoutez du contenu à la zone du pied de page';
$string['footerdesc'] = 'Ajoutez un titre à la zone du pied de page';
...
$string['gdprbuttondesc'] = 'Affichez le bouton Résumé de la conservation des données dans le pied de page.';
...
$string['header2searchbox'] = 'Boîte de recherche extensible de l\'en-tête 2';
$string['header2searchboxdesc'] = 'Développez et réduisez les fonctionnalités de la zone de recherche lorsque vous utilisez l\'en-tête 2.';
$string['headerbgimage'] = 'Image d\'arrière-plan';
$string['headerbgimagedesc'] = 'Définissez une image d\'arrière-plan dans l\'en-tête. La taille minimale est 1600x180px (1900x180px recommandé). L\'image recouvre l\'en-tête complet. Vous pouvez ajouter une couleur dans la «Couleur de fond de l\'en-tête supérieur (Top)» ou utiliser <i> transparent </i> pour afficher l\'image d\'arrière-plan. Dans ce cas, modifiez la couleur du texte pour l\'afficher correctement sur l\'image.';
$string['headerbkcolor'] = 'Couleur de fond de l\'en-tête Supérieur (Top)';
...
$string['headerdesc'] = 'Téléchargez votre favicon, définissez le formulaire de connexion dans l\'en-tête, réglez les titres dans l\'en-tête. <br />
Vous pouvez définir la taille et les styles de la police pour les titres dans la page de configuration des <a href="./../admin/settings.php?section=theme_adaptable_font">polices du thème</a>.';
...
$string['headersettingsheading'] = 'Personnalisez l\'en-tête de ce thème. Voir la mise en page <a href="./../theme/adaptable/pix/layout.png" target="_blank">ici</a>';
...
$string['headerstyledesc'] = 'Choisissez le style de l\'en-tête. L\'en-tête 1 fait référence à l\'en-tête Adaptable d\'origine à 3 lignes. L\'en-tête 2 est un en-tête minimal de 2 lignes. Notez qu\'en cas d\'utilisation de l\'en-tête 2, le paramètre « Utiliser le champ de recherche ou les icônes sociales » utilisera toujours un champ de recherche.';
$string['headertextcolor'] = 'Couleur du texte et des liens du bloc d\'en-tête Top';
...
$string['help'] = 'Aide';
$string['helpprofilefield'] = 'Champ d\'aide du profil personnalisé (optionnel)';
$string['helpprofilefielddesc'] = 'Ajoutez une règle d\'accès pour les champs de profil personnalisé, par ex : usertype=student';
...
$string['hide'] = 'Cacher';
$string['hidealertsmobile'] = 'Cacher les alertes sur mobile (si utilisé)';
$string['hidealertsmobiledesc'] = '« Cacher » supprimera les alertes sur les appareils mobiles';
$string['hideblocks'] = 'Cacher les blocs';
$string['hidebreadcrumbmobile'] = 'Cacher le fil d\'ariane sur les mobiles';
$string['hidebreadcrumbmobiledesc'] = 'Cocher cette option supprimera le fil d\'ariane sur les appareils mobiles';
$string['hidecoursetitlemobile'] = 'Cacher le nom du site / des cours sur mobile';
$string['hidecoursetitlemobiledesc'] = 'Cacher le nom du site ET le nom des cours sur mobile';
...
$string['hideheadermobile'] = 'Cacher l\'en-tête sur mobile';
$string['hideheadermobiledesc'] = '« Cacher » enlèvera les en-têtes avec les logo, icônes de réseaux sociaux, zone de recherche sur les appareils mobiles';
...
$string['hidelogomobile'] = 'Cacher le Logo sur mobile';
$string['hidelogomobiledesc'] = '« Cacher » enlèvera le logo sur les appareils mobiles';
$string['hidepagefootermobile'] = 'Cacher le pied de page sur Mobile';
$string['hidepagefootermobiledesc'] = 'Choisir cette option enlèvera le pied de page sur les appareils mobiles';
$string['hideslidermobile'] = 'Cacher le diaporama sur mobile';
$string['hideslidermobiledesc'] = '« Cacher » enlèvera le diaporama sur les appareils mobiles';
$string['hidesocialmobile'] = 'Cacher les icônes de réseaux sociaux sur mobile (si utilisé)';
$string['hidesocialmobiledesc'] = '« Cacher » enlèvera les icônes de réseaux sociaux sur les appareils mobiles';
$string['home'] = 'Accueil';
...
$string['infobox2desc'] = 'Fenêtre d\'info secondaire de la page d\'accueil (Voir le fichier <a href="./../theme/adaptable/README.txt" target="_blank">README</a> pour des informations et des conseils supplémentaires).';
...
$string['layoutaddcontentdesc2'] = 'les blocs de marketing. Si vous êtes satisfait de cette disposition, ajoutez du contenu aux blocs ci-dessous.
Sinon, utilisez le générateur de mise en page ci-dessus pour faire des changements.<br />';
...
$string['layoutmobilesettings'] = 'Paramètres des mobiles';
$string['layoutmobilesettingsdesc'] = 'Modifier les paramètres des périphériques mobiles';
...
$string['marketblockbordercolordesc'] = 'Ce champ permet de définir la couleur de la bordure du bloc Marketing';
...
$string['marketingdesc'] = 'Vous pouvez utiliser deux styles différents de fenêtres d\'information pleine largeur.
En plus, il existe un générateur de mise en page qui vous permet de décider du nombre de blocs dont vous avez besoin et de définir votre propre mise en page, voir le fichier <a href="./../theme/adaptable/README.txt" target="_blank">README</a> livré avec ce thème.';
...
$string['menubkcolordesc'] = 'Ce champ permet de définir la couleur de fond du menu principal.';
$string['menubordercolor'] = 'Couleur de la bordure haute du menu principal';
$string['menubordercolordesc'] = 'Ce champ permet de définir la couleur de la bordure haute du menu principal.';
$string['menufontcolor'] = 'Couleur de la police du menu principal';
$string['menufontcolordesc'] = 'Ce champ permet de définir la couleur de la police du menu principal';
...
$string['menuhovercolordesc'] = 'Ce champ permet de définir la couleur de survol du menu principal';
...
$string['menuslinkrightdesc'] = 'Si cette option est cochée, affiche le lien vers les menus en haut à côté du menu des message';
$string['menustitledesc'] = 'Les menus d\'outils (navbar) et les menus supérieurs (en-tête supérieur) peuvent être restreints en fonction de champs de profil personnalisés (facultatif). Pour ajouter une restriction, entrez le nom du champ de profil et la valeur attendue. La structure du menu suit le format commun de Moodle :
<pre>
...
$string['menuuseroverridedesc'] = 'Ces paramètres peuvent être utilisés pour que les utilisateurs puisse contrôler l\'apparence des menus via un champ de profil personnalisé. Pour utiliser cette option, vous devrez créer un champ de profil personnalisé au format « liste » avec des valeurs dans l\'ordre correspondant :
...
Vous ne devez PAS utiliser l\'option « Désactiver les menus sur les pages de cours » en conjonction avec les paramètres du champ de profil. Utilisez plutôt la valeur par défaut pour votre entrée « Pages propres uniquement » lors de la configuration de votre liste de champs de profil.
...
$string['mobilemenubkcolordesc'] = 'Ce champ permet de définir la couleur de fond du menu principal sur les appareils mobiles (réduit)';
$string['mobilesettings'] = 'Réglages Mobile';
$string['mobilesettingsheading'] = 'Contrôlez comment s\'affiche votre site sur des appareils mobiles';
...
$string['navbarcachetime'] = 'Durée du cache de la navbar';
...
$string['navbarmenusettings'] = 'Menu Outils de la navbar';
...
$string['navbarsettings'] = 'En-tête de la navbar';
...
$string['newmenu1triggerdesc'] = 'Définissez un Mot 1 d\'activation du menu déroulant principal. La police d\'icône Awesome peut être utilisée';
$string['newmenu2trigger'] = 'Mot 2 d\'activation du menu déroulant principal';
$string['newmenu2triggerdesc'] = 'Définissez un Mot 2 d\'activation du menu déroulant principal. La police d\'icône Awesome peut être utilisée';
...
$string['newstickercountdesc'] = 'Définissez plusieurs sections du fil d\'information avec des règles d\'accès pour cibler différents publics';
...
$string['pageheaderheightdesc'] = 'Définissez la hauteur de la zone d\'en-tête principale (contenant le logo et les titres)';
...
$string['piwiksiteurldesc'] = 'Entrez votre URL de Matomo Analytics sans http (s) ou slash à la fin (/)';
...
$string['putpropertyproperties'] = 'Proriétés';
...
$string['searchcourses'] = 'Rechercher un cours';
$string['sectionheadingcolor'] = 'Couleur du texte d\'en-tête des sections';
$string['sectionheadingcolordesc'] = 'Ce champ permet de définir la couleur du texte d\'en-tête des sections.';
$string['selectionbackground'] = 'Couleur du fond sélectionné';
...
$string['settingssmallscreen'] = 'Apparence du bloc petit écran';
...
$string['sitetitlecustom'] = 'Utiliser un titre de site personnalisé (entrer dans la zone de texte ci-dessous)';
$string['sitetitledefault'] = 'Utilisez le titre du site Moodle (nom du site)';
$string['sitetitledesc'] = 'Affichez le titre par défaut du site Moodle à partir <a href="./../admin/settings.php?section=frontpagesettings" target="_blank">des paramètres de la page d\'accueil</a> ou entrez un titre de site personnalisé dans la zone de texte ci-dessous. Si vous ajoutez une image de logo, le titre ne sera pas affiché.';
$string['sitetitlemaxwidth'] = 'Largeur maximale du titre du site';
$string['sitetitlemaxwidthdesc'] = 'Définissez la largeur maximale de la zone du titre du site';
$string['sitetitleoff'] = 'Désactiver le titre du site';
$string['sitetitlepaddingleft'] = 'Espacement gauche du titre du site';
$string['sitetitlepaddingleftdesc'] = 'Définissez l\'espacement gauche du titre du site pour ajuster la position';
$string['sitetitlepaddingtop'] = 'Espacement au dessus du titre du site';
$string['sitetitlepaddingtopdesc'] = 'Définissez l\'espacement au dessus du titre du site pour ajuster la position';
$string['sitetitletext'] = 'Titre du site';
$string['sitetitletextdesc'] = 'Titre du site affiché dans l\'en-tête. Vous pouvez utiliser n\'importe quelle balise HTML et appliquer des styles en ligne. Il est recommandé d\'ajouter une balise H1 si vous voulez ajouter le titre du site à la place d\'une balise P.';
...
$string['slider2h3colordesc'] = 'Ce champ permet de définir la couleur du texte de la balise H3 du diaporama 2';
$string['slider2h4bgcolor'] = 'Couleur d\'arrière-plan de la balise H4 du diaporama 2';
$string['slider2h4bgcolordesc'] = 'Ce champ permet de définir la couleur d\'arrière-plan pour la balise H4 du diaporama 2';
$string['slider2h4color'] = 'Couleur du texte de la balise H4 du diaporama 2';
$string['slider2h4colordesc'] = 'Ce champ permet de définir la couleur du texte de la balise H4 du diaporama 2';
...
$string['slidercountdesc'] = 'Sélectionnez le nombre de diapositives que vous souhaitez ajouter <strong> puis cliquez sur Enregistrer </strong> pour sauvegarder les champs saisis.';
...
$string['sliderfullscreendesc'] = 'Cochez cette case pour afficher le diaporama en plein écran (largeur 100%)';
$string['sliderh3color'] = 'Couleur de la balise H3 du diaporama 1';
$string['sliderh3colordesc'] = 'Ce champ permet de définir la couleur de la balise H3 du diaporama 1';
$string['sliderh4color'] = 'Couleur de la balise H4 du diaporama 1';
$string['sliderh4colordesc'] = 'Ce champ permet de définir la couleur de la balise H4 du diaporama 1';
$string['sliderimage'] = 'Image du diaporama';
$string['sliderimagedesc'] = 'Ajoutez une image pour votre diapositive. La taille recommandée est 1600px x 400px ou plus.';
...
$string['slideroption2'] = 'Choisissez le type de diaporama';
...
$string['slideroption2colordesc'] = 'Ce champ permet de définir la couleur d\'arrière-plan pour le texte envoyé dans l\'option style du diaporama';
$string['slideroption2desc'] = 'Choisir le type de diaporama, <strong> puis cliquer sur SAUVEGARDER</strong> pour voir les paramètres de couleur du diaporama choisi';
$string['slideroption2snippet'] = '<p>Exemple de texte en HTML pour les légendes de diaporama :</p>
<pre>
<div class="span6 col-sm-6">
<h4>Pixels et code </h4><h3>fait main</h3><h4> pour la communauté Moodle.</h4>
<a href="#" class="submit">Veuillez soutenir notre thème !</a>
</pre>';
$string['slideroption2submitcolor'] = 'Texte du diaporama 2 soumis';
$string['slideroption2submitcolordesc'] = 'Ce champ permet de définir une couleur de fond pour le texte soumis dans l\'option de couleur du style 2 du diaporama';
$string['sliderstyle1'] = 'Style 1 du diaporama';
$string['sliderstyle2'] = 'Style 2 du diaporama';
$string['slidersubmitbgcolor'] = 'Couleur de fond du bouton Soumettre du diaporama 1';
$string['slidersubmitbgcolordesc'] = 'Choisissez la couleur d\'arrière-plan du bouton « Soumettre » du diaporama 1';
$string['slidersubmitcolor'] = 'Texte du bouton Soumettre du diaporama 1';
$string['slidersubmitcolordesc'] = 'Ce champ permet de définir la couleur du texte du bouton « Soumettre » du diaporama 1';
...
$string['smallscreenhidebreadcrumb'] = 'Masquer la navigation du fil d\'Ariane';
$string['smallscreenhidebreadcrumbdesc'] = 'Masquer la navigation du fil d\'Ariane sur les appareils à petit écran.';
$string['smallscreenshowsearchicon'] = 'Afficher l\'icône de recherche';
$string['smallscreenshowsearchicondesc'] = 'Afficher l\'icône de recherche sur les appareils à petit écran.';
$string['socialheading'] = 'Paramètres des icônes de réseaux sociaux';
$string['socialicondesc'] = 'Définissez l\'icône de la police Awesome, par exemple : fa-facebook';
$string['socialiconlist'] = 'Liste des icônes de réseaux sociaux';
$string['socialiconlistdesc'] = 'Entrez une liste délimitée pour configurer les icônes / liens sociaux dont vous avez besoin en utilisant le format : url|title|icon';
$string['socialorsearch'] = 'Utilisez la case de recherche ou les icônes de réseaux sociaux';
$string['socialorsearchdesc'] = 'Vous pouvez définir le thème pour afficher des icônes sociales ou un champ de recherche dans l\'en-tête.<br />
Vous pouvez définir des icônes des réseaux sociaux sur la page de paramètres <a href="./../admin/settings.php?section=theme_adaptable_social">En-tête social</a> </strong>.';
$string['socialorsearchnone'] = 'Aucune';
$string['socialorsearchsearch'] = 'Afficher le champ de recherche dans l\'en-tête';
$string['socialorsearchsocial'] = 'Afficher les icônes des réseaux sociaux dans l\'en-tête';
...
$string['socialsizemobile'] = 'Définissez la taille de la police des icônes des réseaux sociaux sur Mobile';
$string['socialsizemobiledesc'] = 'Pour une meilleure vue, la taille doit être supérieure de 5 pixels à la taille réelle souhaitée.';
$string['socialtarget'] = 'Cible d\'ouverture des liens vers les réseaux sociaux';
$string['socialtargetdesc'] = 'Comment souhaitez-vous que les liens vers les réseaux sociaux s\'ouvrent (même ou nouvelle fenêtre)';
$string['socialtitledesc'] = 'Vous pouvez désactiver la zone de recherche du site et activer les icônes/liens vers les réseaux sociaux à la place.
Pour configurer les icônes, entrez une liste restreinte dans le champ « Liste des icônes réseaux sociaux » ci-dessous.
...
Vous pourrez trouver la liste complète des <a href="https://fortawesome.github.io/Font-Awesome/icons/">Font Awesome Icons Ici</a>';
...
$string['socialwalldesc'] = 'Personnalise l\'apparence du <a href="https://moodle.org/plugins/format_socialwall">Format du Mur social</a> (si utilisé sur votre site)';
...
$string['standardscreenwidthdesc'] = 'Définissez la largeur du thème en mode d’écran standard/sans zoom.';
$string['standardview'] = 'Vue standard';
$string['stickynavbar'] = 'Navbar fixée en haut';
$string['stickynavbardesc'] = 'Fixez la Navbar en haut de l\'écran lorsque vous déroulez vers le bas.';
...
$string['tabbedlayoutheading'] = 'Disposition à onglets adaptable';
...
$string['tickersettings'] = 'Lecteur de nouvelles';
$string['tickertext'] = 'Texte du lecteur de nouvelles';
...
$string['tickerwidth'] = 'Largeur du lecteur de nouvelles';
...
$string['tilesbordercolordesc'] = 'Ce champ permet de définir la couleur de la bordure du pavé « boite de cours ».';
...
$string['toolsmenuscountdesc'] = 'Définissez le nombre de menus d\'outils que vous souhaitez ajouter à la barre de navigation principale.';
$string['toolsmenutitle'] = 'Titre du menu Outils';
$string['toolsmenutitledefault'] = 'Outils';
$string['toolsmenutitledesc'] = 'Ajoutez le titre du menu que vous souhaitez afficher dans la barre de navigation principale';
...
$string['topmenufontsizedesc'] = 'Ajustez la taille de la police des menus principal (Top)';
$string['topmenuscount'] = 'Nombre de menus du haut (top)';
$string['topmenuscountdesc'] = 'Définissez le nombre de menus du haut (top) que vous souhaitez ajouter à l\'en-tête du thème';
...
$string['usersettings'] = 'utilisateur';
$string['usersettingsdesc'] = 'Définir les paramètres pour l\'utilisateur.';
$string['usersettingsheading'] = 'Aspects de contrôle de l\'utilisateur';
...
$string['xofysubmitted'] = '{$a->completed} sur {$a->participants} soumis';
