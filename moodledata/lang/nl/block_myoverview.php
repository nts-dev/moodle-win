...
/**
 * Strings for component 'block_myoverview', language 'nl', branch 'MOODLE_37_STABLE'
 *
...
$string['all'] = 'Alle';
$string['allexcepthidden'] = 'Alle (behalve verborgen)';
$string['aria:addtofavourites'] = 'Favoriet voor';
$string['aria:allcourses'] = 'Alle cursussen';
$string['aria:allcoursesexcepthidden'] = 'Alle cursussen behalve verborgen cursussen';
