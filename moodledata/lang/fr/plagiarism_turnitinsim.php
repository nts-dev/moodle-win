...
/**
 * Strings for component 'plagiarism_turnitinsim', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['excludequotes'] = 'Citations';
...
$string['line'] = 'Ligne';
$string['loadingcv'] = 'Chargement de Turnitin Cloud Viewer';
...
$string['privacy:metadata:plagiarism_turnitinsim_client:firstname'] = 'Le nom de l\'utilisateur est envoyé à Turnitin lors d\'un lancement de Cloud Viewer afin qu\'il puisse être identifié.';
$string['privacy:metadata:plagiarism_turnitinsim_client:lastname'] = 'Le nom de l\'utilisateur est envoyé à Turnitin lors d\'un lancement de Cloud Viewer afin qu\'il puisse être identifié.';
...
$string['taskoutputfailedcvlaunchurl'] = 'Un problème est survenu lors de la demande d\'une URL de lancement de Cloud Viewer à partir de l\'API Turnitin pour le numéro d\'envoi suivant : {$a}';
...
$string['turnitinfeatures::viewoptions'] = 'Options de Cloud Viewer :';
