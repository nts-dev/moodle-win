...
$string['core.cannotconnect'] = 'Connexion impossible : vérifiez que l\'URL a été saisie correctement et que votre site utilise Moodle {{$a}} ou ultérieur.';
...
$string['core.login.newsitedescription'] = 'Veuillez saisir l\'URL de votre plateforme Moodle. Notez qu\'elle peut ne pas être configurée pour fonctionner avec cette app.';
$string['core.login.notloggedin'] = 'Vous devez être connecté.';
$string['core.login.passwordrequired'] = 'Mot de passe requis';
$string['core.login.problemconnectingerror'] = 'Impossible de se connecter à';
$string['core.login.problemconnectingerrorcontinue'] = 'Veuillez vérifier l\'adresse indiquée et essayer à nouveau.';
...
$string['core.login.siteaddress'] = 'Adresse de la plateforme';
...
$string['core.login.webservicesnotenabled'] = 'Les Services web ne sont pas activés sur votre site. Veuillez contacter l\'administrateur de votre site si vous pensez qu\'ils devraient être activés.';
$string['core.lostconnection'] = 'Votre jeton n\'est pas valide ou est échu. Veuillez vous reconnecter à la plateforme.';
$string['core.mainmenu.appsettings'] = 'Réglages de l\'app';
...
$string['core.question.errorattachmentsnotsupported'] = 'L\'application ne permet pas encore d\'annexer des fichiers aux réponses.';
$string['core.question.errorinlinefilesnotsupported'] = 'L\'app ne permet pas encore la modification de fichiers en ligne.';
...
$string['core.settings.appready'] = 'Prêt pour l\'app';
...
$string['core.settings.devicewebworkers'] = 'Web workers supportés';
...
$string['core.settings.versioncode'] = 'Code de version';
$string['core.settings.versionname'] = 'Nom de version';
