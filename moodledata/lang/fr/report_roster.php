...
/**
 * Strings for component 'report_roster', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['settings:show_username'] = 'Afficher le nom d\'utilisateur';
$string['settings:show_username:description'] = 'Afficher le nom d\'utilisateur sous le nom complet dans le trombinoscope.';
