...
/**
 * Strings for component 'block_timeline', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['ariaeventlistitem'] = 'L\'activité {$a->name} dans {$a->course} doit être rendue le {$a->date}';
