...
/**
 * Strings for component 'facetoface', language 'fr', branch 'MOODLE_35_STABLE'
 *
 * @package   facetoface
...
$string['attendeestablesummary'] = 'Personnes planifiant de ou ayant participé à cette session.';
