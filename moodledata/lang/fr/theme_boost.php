...
/**
 * Strings for component 'theme_boost', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   theme_boost
...
$string['fontsize'] = 'Corps de base du thème';
$string['fontsize_desc'] = 'Saisir une taille de corps en %';
