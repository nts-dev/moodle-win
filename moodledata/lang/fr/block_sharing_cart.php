...
/**
 * Strings for component 'block_sharing_cart', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['confirm_userdata_section'] = 'Voulez-vous inclure les données utilisateur dans une copie de ces ressources / activités ?
OK - copier *avec* les données utilisateur
Annuler - copier *sans* les données utilisateur';
