...
/**
 * Strings for component 'tool_behat', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   tool_behat
...
$string['errorapproot'] = '$CFG->behat_ionic_dirroot ne pointe pas vers une installation de développeur Moodle Mobile.';
