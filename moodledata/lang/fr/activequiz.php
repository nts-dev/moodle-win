...
/**
 * Strings for component 'activequiz', language 'fr', branch 'MOODLE_32_STABLE'
 *
 * @package   activequiz
...
$string['fullanonymize'] = 'Anonymiser complètement les réponses des élèves';
$string['fullanonymize_help'] = 'Anonymiser complètement les réponses des élèves. Veuillez noter que si vous sélectionnez cette option, les réponses de cette session ne seront pas validées et appliquées aux élèves.';
