...
/**
 * Strings for component 'block_xp', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   block_xp
...
$string['admindefaultsettingsintro'] = 'Les réglages ci-dessous seront utilisés par défaut quand le bloc est ajouté dans un cours.';
...
$string['limitparticipants_help'] = 'Ce réglage contrôle qui est affiché dans le classement. Les voisins sont les participants classés au-dessus ou en-dessous de l\'utilisateur actuel. Par exemple, si vous choisissez « Afficher 2 voisins », seuls les deux participants classés directement au-dessus et en-dessous de l\'utilisateur actuel seront affichés.';
...
$string['shortcode:xpladder'] = 'Afficher une partie du classement autour du rang de l\'utilisateur actuel.';
