...
/**
 * Strings for component 'checklist', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   checklist
...
Si un élément est lié à un cours et que pour ce cours l\'achèvement a été activé, l\'élément sera mis à jour lorsque ce cours est marqué comme terminé.';
