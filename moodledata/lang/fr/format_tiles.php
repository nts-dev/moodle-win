...
/**
 * Strings for component 'format_tiles', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['allowlabelconversion'] = 'Autoriser la conversion des étiquettes en pages (expérimental)';
$string['allowlabelconversion_desc'] = 'Si cette option est cochée, les enseignants éditeurs auront une option dans les paramètres d\'édition de chaque étiquette pour convertir l\'étiquette en une page. C\'est dans un cadre expérimental.';
...
$string['basecolour_help'] = 'La couleur définie ici sera appliquée à toutes les tuiles du cours.';
...
$string['collapsesections'] = 'Réduire toutes les sections';
$string['colourblue'] = 'Bleu';
$string['colourdarkgreen'] = 'Vert foncé';
$string['colourgreen'] = 'Vert';
$string['colourlightblue'] = 'Bleu clair';
$string['colourname_descr'] = 'Nom d\'affichage de la couleur (par ex. « Bleu » à utiliser dans les menus déroulants lors du choix d\'une couleur pour un cours.';
...
$string['datapreferror'] = 'La fonction de préférence de données n\'est disponible que si vous avez javascript disponible dans votre navigateur. Sinon, le stockage des données ne peut pas être activé.';
$string['dataprefquestion'] = '<p>Pour faciliter l\'utilisation de ce site, nous stockons des informations fonctionnelles dans votre navigateur telles que le contenu de la dernière tuile que vous avez ouverte. Ceci reste sur votre machine pendant un court moment au cas où vous visiteriez cette page à nouveau. Nous ne l\'utilisons pas pour le suivi. Êtes-vous d\'accord ? </p><p>Nous nous souviendrons de votre choix jusqu\'à ce que vous effaciez votre historique de navigation. Dire « Non » peut ralentir le temps de chargement des pages.</p>';
...
$string['defaulttileicon_help'] = 'L\'icône sélectionnée ici apparaîtra sur <em>toutes</em> les tuiles dans ce cours. Des tuiles individuelles peuvent avoir une icône différente sélectionnée, en utilisant les différents réglages au niveau des tuiles.';
$string['deleteimage'] = 'Supprimer l\'image';
$string['deletesection'] = 'Supprimer la tuile';
$string['developedby'] = '« Tiles » développé par {$a}';
...
$string['hovercolour'] = 'Couleur du survol des tuiles';
...
$string['jsnavsettings'] = 'Paramètres de navigation Javascript';
$string['jsreactivated'] = 'Vous avez activé la navigation animée. Cela peut être plus rapide à utiliser. Il nécessite l\'activation de Javascipt.';
...
$string['modalmodules_desc'] = 'Lancer ces modules de cours dans une fenêtre modale';
$string['modalresources'] = 'Ressources modales';
$string['modalresources_desc'] = 'Lancer ces ressources dans une fenêtre modale';
...
$string['nojswarning'] = 'Votre navigateur ne semble pas supporter javascript, ou semble désactivé. Une interface améliorée est disponible si vous activez Javascript';
$string['none'] = 'Aucun';
...
$string['privacy:metadata:preference:format_tiles_stopjsnav'] = 'Si l\'utilisateur a désactivé la navigation javascript animée.';
...
$string['settings'] = 'Paramètres du format Tuile';
...
$string['snapwarning'] = 'Il peut être possible d\'éditer votre cours au format Tuiles en utilisant un autre thème, puis de revenir au thème Snap une fois que vous avez terminé l\'édition.';
...
$string['tilecolourgeneral_descr'] = 'Une couleur optionnelle à proposer aux utilisateurs comme couleur de tuiles de cours dans le menu déroulant sous Administration des cours > Modifier les paramètres - laissez vide pour désactiver cette couleur.';
...
$string['tileselecttip'] = 'Vous n\'avez pas besoin d\'utiliser ce formulaire pour changer une icône de tuile. Un moyen plus simple est, dans le cours, de cliquer sur l\'icône que vous voulez changer (avec le mode édition activé).';
$string['tip'] = 'Astuce';
...
$string['usejavascriptnav'] = 'Utiliser la navigation javascript à partir de la page d\'accueil des tuiles';
...
$string['usejsnavforsinglesection_desc'] = 'Une fois coché, tout appel pour une seule section par page (&section=xx) sera traité en utilisant javascript, en lançant la page principale du cours, animée pour s\'ouvrir à la section demandée via JS, plutôt que d\'appeler l\'ancienne page de section unique PHP.';
