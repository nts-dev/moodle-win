...
/**
 * Strings for component 'groupformation', language 'nl', branch 'MOODLE_35_STABLE'
 *
...
$string['analysis_status_info0'] = 'Je kunt een activiteit starten of beëindigen.';
$string['analysis_status_info1'] = 'Je moet stoppen met de activiteit voor de groepformatie.';
$string['analysis_status_info2'] = 'Je moet beginnen met de activiteit zodat leerlingen de vragenlijst kunnen beantwoorden.';
$string['analysis_status_info3'] = 'Groepformatie is al begonnen of afgerond. Je kunt niet meer starten met de activiteit. Als je opnieuw wilt beginnen, moet je alle aangemaakte groepen verwijderen.';
$string['analysis_status_info4'] = 'Je kunt nu de groepsformatie starten.';
...
$string['groups_build'] = 'Groepen zijn aangemaakt.';
...
$string['participant_code_example'] = 'Bijvoorbeeld: EV07AD11';
$string['participant_code_footer'] = 'Jouw persoonlijke deelnemerscode is';
$string['participant_code_header'] = 'Vul een persoonlijke deelnemerscode in op de volgende manier:';
$string['participant_code_rules'] = '1. De voornaam van jemoeder (eerste twee letters, in hoofdletters, bijv. EV voor Eva)<br>
2. De maand van de verjaardag van je moeder (als twee nummers, bijv. 07 voor juli)<br>
3. De voornaam van je vader (eerste twee letters, in hoofdletters, bijv. AD voor Adam)<br>
4. De maand van de verjaardag van je moeder (als twee nummers, bijv. 11 voor november)<br><br>
Vervang diacritische en speciale tekens als volgt<br>
Ä → A; Ö → O; Ü → U; ß → S';
