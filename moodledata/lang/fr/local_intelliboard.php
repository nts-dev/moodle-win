...
/**
 * Strings for component 'local_intelliboard', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['activity_grades'] = 'Niveaux d\'activité';
$string['activity_name'] = 'Nom de l\'activité';
$string['activity_participation'] = 'Participation à l\'activité';
$string['activity_progress'] = 'Progression de l\'activité';
$string['adv_settings'] = 'Paramètre avancé';
...
$string['assignment_name'] = 'Nom du devoirs';
...
$string['n2'] = 'Aperçu [Grade Progress]';
$string['n3'] = 'Aperçu [Activity Progress]';
$string['n4'] = 'Aperçu [Totals]';
...
$string['s45'] = 'Activité';
$string['s46'] = 'Pourcentage d\'étudiants qui ont essayer';
$string['s47'] = 'Sujet';
...
$string['t44'] = 'Activer la colonne Score [Activity Grades]';
...
$string['te1_desc'] = 'Entrez le prénom, le nom, le courriel utilisé avec l\'abonnement IntelliBoard.net. Si vous n\'avez pas d\'abonnement actif, inscrivez-vous sur <a target="_blank" href="https://intelliboard.net"> IntelliBoard.net </a>. Le tableau de bord de l\'apprenant et de l\'instructeur est disponible avec un abonnement de niveau 3 et plus.';
$string['teacher'] = 'Prof';
