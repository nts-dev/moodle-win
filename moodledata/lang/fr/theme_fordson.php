...
/**
 * Strings for component 'theme_fordson', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['commonlyuseddesc'] = 'Liste des activités/ressources séparées par des virgules pour les lister en haut du sélecteur d\'activités/ressources:<br>
...
$string['iconwidthinfodesc'] = 'Sélectionner une largeur permettant au lien texte de s\'accorder avec le « bouton-icône » de navigation';
...
$string['loginnavicontitletextdesc'] = 'Texte à afficher sous l\'icône en tant que titre.';
...
$string['marketingicon'] = 'Lien de l\'icône';
...
$string['modchoosersettingspage'] = 'Activités/Ressources';
...
$string['mycoursetitledesc'] = 'Modifie le nom du menu « Mes cours » dans la barre de navigation supérieure.';
...
$string['naviconbuttonurldesc'] = 'URL vers laquelle le bouton redirige. Vous pouvez créer un lien vers n\'importe où, même vers un site web extérieur, il vous suffit de saisir l\'URL correcte. Si votre site Moodle se situe dans un sous-dossier, l\'URL par défaut ne fonctionnera pas. Veuillez modifier l\'URL pour prendre en compte le sous-répertoire. Exemple : si « moodle » est votre sous-dossier, votre URL deviendra /moodle/my/';
...
$string['showstudentgrades_desc'] = 'Affiche un lien vers le carnet de notes de l\'étudiant dans le panneau de gestion de cours pour les apprenants. L\'option « Afficher le carnet de notes aux étudiants » doit être activée dans le cours pour que cette option fonctionne.';
...
$string['sliderinfo'] = 'Bouton-icône spéciale';
$string['sliderinfodesc'] = 'Ce bouton montrera/cachera une boîte à texte spéciale qui glisse vers le bas depuis la barre de navigation des icônes. C\'est idéal pour présenter des cours, offrir de l\'aide, ou lister les entraînements du personnel requis.';
...
$string['sociallinkicondesc'] = 'Saisir le nom fontawesome de l\'icône pour votre lien<br />Une liste complète d\'icônes fontawesome peut être trouvé sur https://fontawesome.io/icons';
