...
/**
 * Strings for component 'block_panopto', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['block_panopto_async_tasks'] = 'Activer les tâches de synchronisation asynchrone (non recommandé)';
$string['block_panopto_async_tasks_desc'] = 'Activez cette option pour autoriser les tâches de connexion, d\'inscription, d\'annulation d\'inscription, d\'application de catégorie et de suppression d\'utilisateurs de manière asynchrone. Si cette option est désactivée, ces opérations ont lieu de manière synchrone dans le gestionnaire d\'événements. Cette option n\'est pas recommandée car il est difficile de détecter la défaillance de manière ponctuelle.';
