...
/**
 * Strings for component 'offlinequiz', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   offlinequiz
...
$string['configexperimentalevaluationdesc'] = 'NE PAS UTILISER EN PRODUCTION ! Cette option est utilisée pour les tests alpha de l\'algorithme d\'évaluation ne. Si cette option est activée, vous pouvez l\'activer dans les options de l\'instance offlinequiz. Nous déconseillons fortement d’utiliser cette option. Aucune assistance n\'est fournie pour des données perdues suite à l\'activation de cette option.';
...
$string['marginwarning'] = 'Veuillez imprimer les fichiers PDF suivants sans marges additionnelles !<br /> Évitez d\'utiliser des photocopies. Dans le doute commandez des copies à l\'équipe de support.';
$string['marks'] = 'Points';
...
$string['privacy:metadata:core_files'] = 'Offlinequiz utilise l\'API de fichier pour stocker les feuilles de questions et réponses générées ainsi que les feuilles de réponses remplies.';
...
$string['privacy:metadata:offlinequiz'] = 'La table offlinequiz enregistre toutes les informations spécifiques à une instance offlinequiz.';
...
$string['privacy:metadata:offlinequiz_choices:scannedpageid'] = 'la page numérisée concernée par le choix';
$string['privacy:metadata:offlinequiz_choices:slotnumber'] = 'La place de la questions de ce choix';
$string['privacy:metadata:offlinequiz_choices:value'] = 'Est-ce que le choix est considéré comme biffé ? 0 pour non, 1 pour oui, -1 pour incertain';
...
$string['privacy:metadata:offlinequiz:grade'] = 'La note indique le nombre maximal de points à obtenir pour ce test';
$string['privacy:metadata:offlinequiz_group_questions'] = 'Cette table enregistre toutes les questions pour chaque groupe offlinequiz.';
...
$string['privacy:metadata:offlinequiz_group_questions:offlinegroupid'] = 'Le groupe offlinequiz auquel cette question de groupe se rapporte';
$string['privacy:metadata:offlinequiz_group_questions:offlinequizid'] = 'Le offlinequizid de cette question de groupe concerne';
...
$string['privacy:metadata:offlinequiz_group_questions:position'] = 'La position dans ce offlinequiz';
$string['privacy:metadata:offlinequiz_group_questions:questionid'] = 'L\'identifiant de la question sélectionnée';
$string['privacy:metadata:offlinequiz_group_questions:slot'] = 'La place de la question dans le quiz';
$string['privacy:metadata:offlinequiz_groups'] = 'Tableau des groupes dans lesquels les tests se déroulent.';
...
$string['privacy:metadata:offlinequiz_groups:number'] = 'le numéro du groupe pour ce offlinequiz, 1 pour le groupe A, 2 pour le groupe B, etc.';
...
$string['privacy:metadata:offlinequiz_groups:questionfilename'] = 'Le nom de fichier qui a été utilisé pour sauvegarder le fichier question';
$string['privacy:metadata:offlinequiz_groups:sumgrades'] = 'la somme de toutes les notes pour toutes les questions de ce groupe';
$string['privacy:metadata:offlinequiz_groups:templateusageid'] = 'L\'identifiant du templateusage, qui est utilisé pour créer un résultat dans l\'API du quiz';
...
$string['privacy:metadata:offlinequiz_hotspots:blank'] = 'Si la zone sensible est analysé avec succès';
$string['privacy:metadata:offlinequiz_hotspots:name'] = 'Type de la zone sensible, par exemple u%number pour la zone sensible de l\'utilisateur, a-0-0 pour la question 1 réponse 1, etc.';
$string['privacy:metadata:offlinequiz_hotspots:scannedpageid'] = 'Page numérisée sur laquelle se trouve la zone sensible.';
$string['privacy:metadata:offlinequiz_hotspots:time'] = 'l\'heure de la dernière mise à jour de cette zone sensible';
$string['privacy:metadata:offlinequiz_hotspots:x'] = 'La valeur x de la zone sensible';
$string['privacy:metadata:offlinequiz_hotspots:y'] = 'La valeur y de la zone sensible';
$string['privacy:metadata:offlinequiz:id_digits'] = 'Sauvegarde le nombre de chiffres que le numéro d\'identification avait lorsque les feuilles de réponses ont été créées. Ceci est nécessaire pour une compatibilité en amont si le montant est augmenté entre la création et l\'importation des feuilles de réponses.';
$string['privacy:metadata:offlinequiz:name'] = 'La colonne « name » enregistre le nom du offlinequiz.';
$string['privacy:metadata:offlinequiz:numgroups'] = 'Le nombre de groupes distincts de ce offlinequiz.';
...
$string['privacy:metadata:offlinequiz_page_corners:position'] = 'L\'information si ce coin est en haut ou en bas et à droite ou à gauche.';
...
$string['privacy:metadata:offlinequiz_participants'] = 'La table des participants enregistre si l\'utilisateur a participé ou non au test.';
$string['privacy:metadata:offlinequiz_participants:checked'] = 'L\'information si cet utilisateur a été coché sur la liste des participants';
$string['privacy:metadata:offlinequiz_participants:listid'] = 'L\'identifiant de la liste de ce participant';
$string['privacy:metadata:offlinequiz_participants:userid'] = 'L\'ID de l\'utilisateur';
...
$string['privacy:metadata:offlinequiz_scanned_p_pages:listnumber'] = 'Le numero de la liste';
$string['privacy:metadata:offlinequiz_scanned_p_pages:offlinequizid'] = 'Le Quiz hors ligne auquel les participants de cette page appartiennent';
...
$string['privacy:metadata:offlinequiz:showquestioninfo'] = 'Enregistre si des informations sur les questions doivent être affichées, 0 pour non, 1 pour des infos sur le type de question, 2 pour questionner sur le nombre de bonnes réponses.';
$string['privacy:metadata:offlinequiz:showtutorial'] = 'Enregistre si les étudiants doivent être invités à suivre un didacticiel sur les tests hors ligne.';
$string['privacy:metadata:offlinequiz:shufflequestions'] = 'Paramètre si les questions doivent être mélangées lors de la création d\'un test. 1 pour mélanger, 0 sinon.';
...
$string['regradinginfo'] = 'Si vous modifiez le score d\'une question, vous devez ré-évaluer le questionnaire hors ligne pour mettre à jour les résultats des participants.';
