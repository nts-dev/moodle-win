...
/**
 * Strings for component 'block_coupon', language 'nl', branch 'MOODLE_37_STABLE'
 *
...
$string['and'] = 'en';
$string['batchidselect'] = 'Batch nummer';
...
{$a->from_name}</p>';
$string['coupon_mail_csv_content'] = 'Beste ##to_gender## ##to_name##,<br /><br />
...
##site_name##';
$string['coupon_mail_csv_content_cohorts'] = 'Beste ##to_gender## ##to_name##,<br /><br />
...
$string['coupon_notification_content'] = '<p>Je ontvangt dit bericht omdat er zojuist nieuwe coupons zijn gegenereerd.<br/>
Je zou een email moeten hebben ontvangen met de details en download link.<br />
Je kunt ook direct de coupon(s) downloaden door {$a} te klikken.</p>';
...
$string['err:not-a-requestuser'] = 'Je hebt niet voldoende rechten om deze pagina te bezoeken';
...
$string['error:validate-courses'] = 'Cursus validatie fout(en):
{$a}';
...
$string['heading:input_cohorts'] = 'Selecteer site-groep(en)';
...
<p>Vriendelijke groet,<br /><br />
{$a->signoff}</p>';
$string['request:accept:custommessage'] = '<p>Volgende opmerking is toegevoegd voor jou: {$a}</p>';
...
$string['view:generator:cohort:heading'] = 'Genereer site-groep coupon(s)';
$string['view:generator:cohort:title'] = 'Genereer site-groep coupon(s)';
