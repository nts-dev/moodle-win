...
/**
 * Strings for component 'atto_poodll', language 'fr', branch 'MOODLE_37_STABLE'
 *
 * @package   atto_poodll
...
$string['snaptheninsert'] = 'Après avoir pris une photo, cliquez sur « Enregistrer », puis sur « Insérer ».';
